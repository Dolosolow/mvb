...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var client_utils_time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! client_utils/time */ \"./src/public/js/utils/time.js\");\n/* harmony import */ var client_utils_markup_movieStartTime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! client_utils/markup/movieStartTime */ \"./src/public/js/utils/markup/movieStartTime.js\");\n/* harmony import */ var _seat_reservations__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./seat-reservations */ \"./src/public/js/reservations/seat-reservations.js\");\n/* harmony import */ var client_utils_ejsupdate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! client_utils/ejsupdate */ \"./src/public/js/utils/ejsupdate.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\nvar socket = io('localhost:5001', {\n  query: \"screenId=\".concat($('#screen-avl__times-list .time').eq(0).data('id'))\n}); // --------------------------\n// A timer where if it reaches 0:00 will cancel any reservations created by that visitor; If they have not\n// reached the checkout phase of the transaction.\n\nfunction setTimer(timeLeft) {\n  $('#mycart__timer span').text(timeLeft);\n} // --------------------------\n// checks for any reservations, any seats with the class active(reserved). If any is found, it applies the attribute \n// disabled to that seat preventing any other visitors from reserving it concurrently.\n\n\nfunction setSeatingGrid(seats) {\n  $('.seat-wrapper button').prop('disabled', false);\n  seats.forEach(function (reservation) {\n    reservation.reserved.forEach(function (seat) {\n      if (!$(\".seat-wrapper[data-id=\\\"\".concat(seat, \"\\\"]\")).children().hasClass('active')) {\n        $(\".seat-wrapper[data-id=\\\"\".concat(seat, \"\\\"]\")).children().prop('disabled', true);\n      }\n    });\n  });\n} // --------------------------\n// When triggered updates the current data with the new screenId request.\n\n\nfunction updateScreenInfo(_x) {\n  return _updateScreenInfo.apply(this, arguments);\n} // --------------------------\n// Targeted towards the dates being screened.  \n\n\nfunction _updateScreenInfo() {\n  _updateScreenInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(screenId) {\n    var response, screenRoom;\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            socket.emit('update seats', screenId);\n            socket.on('update reserved seats', function (_ref2) {\n              var seats = _ref2.seats;\n              setSeatingGrid(seats);\n            });\n            _context2.next = 4;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"/api/movies/screens/\".concat(screenId));\n\n          case 4:\n            response = _context2.sent;\n            screenRoom = response.data.screen.screenRoom;\n            $('#screenRoom').text(screenRoom);\n\n          case 7:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2);\n  }));\n  return _updateScreenInfo.apply(this, arguments);\n}\n\n$('#screen-dates-list').scroll(function () {\n  var movieId = location.pathname.toString().split('/')[2]; // scrolltimer is used as a way to improve user friendliness and avoid multiple calls to the api. \n  // From the inital scroll, the timer starts and if scrolling has stopped for xxxms( set to 800ms) it proceeds\n  // and makes the call to the api fetching the new startTimes for that day. Otherwise ClearTimeout will be\n  // hit on the next scroll resetting the timeout.\n\n  var scrollTimer;\n  clearTimeout(scrollTimer);\n  scrollTimer = setTimeout(function () {\n    $('.screen-avl__date').each( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n      var maxOffset, minOffset, selectedDate, schedule;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              maxOffset = $(window).width() > 700 ? 480 : 145;\n              minOffset = $(window).width() > 700 ? 460 : 130;\n\n              if (!($(this).offset().left >= minOffset && $(this).offset().left <= maxOffset)) {\n                _context.next = 9;\n                break;\n              }\n\n              selectedDate = $(this).data('date');\n              window.history.pushState('', '', \"?date=\".concat(selectedDate));\n              _context.next = 7;\n              return getMovieStartTimes(movieId, selectedDate);\n\n            case 7:\n              schedule = _context.sent;\n              updateScreenInfo(schedule.times[0].id);\n\n            case 9:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, this);\n    })));\n  }, 800);\n}); // --------------------------\n// using the info provided in the parameters it removes the the old time list if any, replacing it with \n// the dates playing for the date selected. \n\nfunction getMovieStartTimes(_x2, _x3) {\n  return _getMovieStartTimes.apply(this, arguments);\n} // ------------------------\n// event handler for when a start time is clicked. If different from the current selected time, changes\n// to the newly selected time, cancels/removes any reservations created prior to the new time clicked, and \n// updates screen info. Otherwise nothing is done.\n\n\nfunction _getMovieStartTimes() {\n  _getMovieStartTimes = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(movieId, selectedDate) {\n    var response;\n    return regeneratorRuntime.wrap(function _callee3$(_context3) {\n      while (1) {\n        switch (_context3.prev = _context3.next) {\n          case 0:\n            $('#screen-avl__times-list').remove();\n            $('#screen-avl__times').append(Object(client_utils_ejsupdate__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(client_utils_markup_movieStartTime__WEBPACK_IMPORTED_MODULE_2__[\"movieStartTimeLoader\"]()));\n            _context3.next = 4;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(\"/api/movies/\".concat(movieId, \"?date=\").concat(selectedDate));\n\n          case 4:\n            response = _context3.sent;\n            $('#screen-avl__times-list').remove();\n            $('#screen-avl__times').append(Object(client_utils_ejsupdate__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(client_utils_markup_movieStartTime__WEBPACK_IMPORTED_MODULE_2__[\"movieStartTime\"](), {\n              times: response.data.schedule.times\n            }));\n            return _context3.abrupt(\"return\", response.data.schedule);\n\n          case 8:\n          case \"end\":\n            return _context3.stop();\n        }\n      }\n    }, _callee3);\n  }));\n  return _getMovieStartTimes.apply(this, arguments);\n}\n\nfunction changeStartTime() {\n  var screenId = $(this).data('id');\n  var currentScreenId = $('#screen-avl__times-list .time.active').data('id');\n\n  if (screenId !== currentScreenId) {\n    $('#screen-avl__times-list .time').removeClass('active');\n    $(this).addClass('active'); // ------------------------\n    // remove selected seats and unreserve them.\n\n    $('#mycart__list .mycart__item').each(function (idx, item) {\n      Object(_seat_reservations__WEBPACK_IMPORTED_MODULE_3__[\"resetSelectedSeats\"])($(item).data('id'));\n    });\n    updateScreenInfo(screenId);\n  }\n}\n\n$('#screen-avl__times').on('click', '#screen-avl__times-list .time', changeStartTime);\n$(document).ready(function () {\n  // ------------------------\n  // helps render page with most current information\n  updateScreenInfo($('#screen-avl__times-list .time.active').data('id')); // ------------------------\n  // reservation timer starts once everything has been rendered.\n\n  client_utils_time__WEBPACK_IMPORTED_MODULE_1__[\"startTimer\"](900, setTimer);\n});\n\n//# sourceURL=webpack:///./src/public/js/reservations/index.js?");
...
/***/ "./src/public/js/utils/markup/cartMarkup.js":
/*!**************************************************!*\
  !*** ./src/public/js/utils/markup/cartMarkup.js ***!
  \**************************************************/
/*! exports provided: cartItemList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"cartItemList\", function() { return cartItemList; });\nfunction cartItemList() {\n  return \"\\n    <ul class=\\\"mycart__list\\\" id=\\\"mycart__list\\\">\\n      <% for(let item of cartItems) { %>\\n        <li class=\\\"mycart__item\\\" data-id=\\\"<%= item.id %>\\\">\\n          <div class=\\\"seat-wrapper\\\">\\n            <div class=\\\"<%= item.seat_type %>\\\"></div>\\n          </div>\\n          <span class=\\\"seat-id\\\"><%= item.id.split('-').join('/') %></span>\\n          <span class=\\\"seat-price\\\">$<%= Number(item.unit_price * item.qty).toFixed(2) %></span>\\n          <span class=\\\"btn-remove-item\\\" id=\\\"remove-cart-btn\\\">&times;</span>\\n        </li>\\n      <% } %>\\n    </ul>\\n  \";\n}\n\n//# sourceURL=webpack:///./src/public/js/utils/markup/cartMarkup.js?");

/***/ }),

/***/ "./src/public/js/utils/markup/movieStartTime.js":
/*!******************************************************!*\
  !*** ./src/public/js/utils/markup/movieStartTime.js ***!
  \******************************************************/
/*! exports provided: movieStartTime, movieStartTimeLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"movieStartTime\", function() { return movieStartTime; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"movieStartTimeLoader\", function() { return movieStartTimeLoader; });\nfunction movieStartTime() {\n  return \"\\n    <div class=\\\"screen-avl__times-list\\\" id=\\\"screen-avl__times-list\\\">\\n      <i class=\\\"fas fa-angle-left text-red\\\"></i>\\n      <% for(let startTime of times) { %>\\n        <p class=\\\"time<%= times[0].id === startTime.id ? ' active' : ''  %>\\\" data-id=\\\"<%= startTime.id %>\\\" ><%= startTime.time %></p>\\n      <% } %> \\n      <i class=\\\"fas fa-angle-right text-red\\\"></i>\\n    </div>\\n  \";\n}\nfunction movieStartTimeLoader() {\n  return \"\\n    <div class=\\\"screen-avl__times-list\\\" id=\\\"screen-avl__times-list\\\">\\n      <i class=\\\"fas fa-angle-left text-red\\\"></i>\\n      <% for(let i = 0; i < 10; i++) { %>\\n        <p class=\\\"time content-ph\\\">00:00</p>\\n      <% } %> \\n      <i class=\\\"fas fa-angle-right text-red\\\"></i>\\n    </div>\\n  \";\n}\n\n//# sourceURL=webpack:///./src/public/js/utils/markup/movieStartTime.js?");

/***/ }),

/***/ "./src/public/js/utils/time.js":
/*!*************************************!*\
  !*** ./src/public/js/utils/time.js ***!
  \*************************************/
/*! exports provided: startTimer, stopTimer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"startTimer\", function() { return startTimer; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"stopTimer\", function() { return stopTimer; });\nvar startTimer = function startTimer(startTime, cb) {\n  var timer = setInterval(function () {\n    var sec = Math.floor(startTime % 60);\n    var min = Math.floor(startTime / 60 % 60);\n\n    if (startTime !== -1) {\n      cb(\"\".concat(min, \":\").concat(sec < 10 ? '0' : '').concat(sec));\n      --startTime;\n    } else {\n      stopTimer(timer);\n    }\n  }, 1000);\n};\nvar stopTimer = function stopTimer(timer) {\n  clearInterval(timer);\n};\n\n//# sourceURL=webpack:///./src/public/js/utils/time.js?");

/***/ }),

/***/ 6:
/*!*****************************************************************************************************!*\
  !*** multi ./src/public/js/reservations/index.js ./src/public/js/reservations/seat-reservations.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! ./src/public/js/reservations/index.js */\"./src/public/js/reservations/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/public/js/reservations/seat-reservations.js */\"./src/public/js/reservations/seat-reservations.js\");\n\n\n//# sourceURL=webpack:///multi_./src/public/js/reservations/index.js_./src/public/js/reservations/seat-reservations.js?");
