...
module.exports = {
  ...
  entry: {
    ...
    main: ['webpack-hot-middleware/client?reload=true&timeout=1000', './src/public/js/pages/index.js', './src/public/js/forms/login-forms.js'],
    memberships: ['./src/public/js/pages/main-membership.js', './src/public/js/forms/signup-forms.js'],
