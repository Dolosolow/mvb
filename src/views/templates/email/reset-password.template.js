      ...
      <td>
        <table align="center" border="0" bgcolor="#fafafa" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
          <tr>
            <!-- img -->
            <td>
              <img src="https://i.ibb.co/txY6SVv/Frame-3.png" role="img" alt="reset your password" width="100%">
            </td>
          </tr>
          <tr>
            <td>
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                ...
                <tr>
                  <td align="center" class="content-body">
                    <p style="margin: 0 0 30px 0; width: 450px;">
                      Please click below to reset your FLIX account password. If you have any questions please contact us at flixsupport@flix.com.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td align="center" class="btn-wrapper" style="padding: 50px 0;">
                    <a href="http://localhost:5001/reset?token=${resetToken}" class="btn-submit">Reset Password</a>
                  </td>
                </tr>
              </table>
            </td>
